...
public class r_add_new_paper extends AppCompatActivity {
    public class r_fragment_paper_upload extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_r_add_new_paper);
            Init();
            select_file.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        ActivityCompat.requestPermissions(com.example.script.r_add_new_paper.this, new String[] {Manifest.permission.READ_EXTERNAL_STORAGE}, 9 );
                    }
            ...
            btn_upload.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        Toast.makeText(com.example.script.r_add_new_paper.this, "Select a file.", Toast.LENGTH_SHORT).show();
                    }
                }
                            ...
                            reference.child(fileName).setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    {                pb_upload.setVisibility(View.GONE);
                                        ...
                                        Toast.makeText(com.example.script.r_add_new_paper.this, "File Successfully Uploaded", Toast.LENGTH_SHORT).show();
                                    }
                                    else
                                    { pb_upload.setVisibility(View.GONE);
                                        Toast.makeText(com.example.script.r_add_new_paper.this, "File Not Uploaded", Toast.LENGTH_SHORT).show();
